...
schemas = {
    'Inventory': Schema(
        ('UPC', valid_upc_or_none_from_str, valid_upc_or_none_from_str),
    ...
    'Product': Schema(
        ...
        ('UPC 1', valid_upc_or_none_from_str, valid_upc_or_none_from_str),
        ('SIZE 2', int_or_none, int_or_none),
        ('UPC 2', valid_upc_or_none_from_str, valid_upc_or_none_from_str),
        ('SIZE 3', int_or_none, int_or_none),
        ('UPC 3', valid_upc_or_none_from_str, valid_upc_or_none_from_str),
        ('SIZE 4', int_or_none, int_or_none),
        ('UPC 4', valid_upc_or_none_from_str, valid_upc_or_none_from_str),
        ('SIZE 5', int_or_none, int_or_none),
        ('UPC 5', valid_upc_or_none_from_str, valid_upc_or_none_from_str),
        ('SIZE 6', int_or_none, int_or_none),
        ('UPC 6', valid_upc_or_none_from_str, valid_upc_or_none_from_str),
        ('SIZE 7', int_or_none, int_or_none),
        ('UPC 7', valid_upc_or_none_from_str, valid_upc_or_none_from_str),
        ('SIZE 8', int_or_none, int_or_none),
        ('UPC 8', valid_upc_or_none_from_str, valid_upc_or_none_from_str),
        ('SIZE 9', int_or_none, int_or_none),
        ('UPC 9', valid_upc_or_none_from_str, valid_upc_or_none_from_str),
        ('SIZE 10', int_or_none, int_or_none),
        ('UPC 10', valid_upc_or_none_from_str, valid_upc_or_none_from_str),
        ('SIZE 11', int_or_none, int_or_none),
        ('UPC 11', valid_upc_or_none_from_str, valid_upc_or_none_from_str),
        ('SIZE 12', int_or_none, int_or_none),
        ('UPC 12', valid_upc_or_none_from_str, valid_upc_or_none_from_str),
        ('SIZE 13', int_or_none, int_or_none),
        ('UPC 13', valid_upc_or_none_from_str, valid_upc_or_none_from_str),
        ('SIZE 14', int_or_none, int_or_none),
        ('UPC 14', valid_upc_or_none_from_str, valid_upc_or_none_from_str),
        ('SIZE 15', int_or_none, int_or_none),
        ('UPC 15', valid_upc_or_none_from_str, valid_upc_or_none_from_str),
    ),
}
